...
export const ExameCard = ({ course, categoria, inicio, fim, exame, vagas, etapas, isOpen }) => {
    ...
    return (
        <div className='p-3 shadow-[var(--boxShadow2)] rounded-xl flex flex-col justify-between gap-2'>
            ...
            <Link to={"/contacto"} className='bg-orange hover:bg-hover rounded-lg text-white flex p-2 items-center justify-center gap-3 transition-all duration-300 ease-in-out'>
