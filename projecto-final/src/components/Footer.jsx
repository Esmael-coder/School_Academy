    ...
    return (
        <footer className=' bg-primary'>
            ...
            <div className='max-w-7xl mx-auto px-4 py-10 sm:p-6 md:p-8 '>
                ...
                <div className='w-full text-white flex flex-col md:flex-row gap-8 md:items-start md:justify-between text-[15px] mb-10'>
                ...
                <div className='w-full border-t-1 border-cinza text-center text-cinza py-4'>
